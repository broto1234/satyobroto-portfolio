...
export default function Hero() {
  return (
    <section id="hero" className="relative flex flex-col items-center justify-center min-h-screen px-4">
      ...
      <div className="absolute -bottom-2 md:bottom-0 left-1/2 transform -translate-x-1/2 flex flex-col items-center  animate-bounce">
        <span>Scroll</span>
        <FiArrowDown className="text-primary" size="36"/>
      </div>                 
    </section>
  )
}
